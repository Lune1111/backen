...
import com.ruoyi.web.controller.sms.QxConstants;
...
public class QxTextMessage
{
    public static String SendSms(String valcode,String[] phoneNumbers ) {
        try {
            ...
            Credential cred = new Credential(QxConstants.SMSSECREID, QxConstants.SMSSECREKEY);
...
//            httpProfile.setProxyPort(port);
            ...
            String appid = QxConstants.SMSAPPID;
            req.setSmsSdkAppid(appid);

            /* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名，签名信息可登录 [短信控制台] 查看 */
            String sign = QxConstants.SMSSIGN;
            req.setSign(sign);
...
//            req.setExtendCode(extendcode);
            ...
            String templateID = QxConstants.SMSTEMPLATEID;
