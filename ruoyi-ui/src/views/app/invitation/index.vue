<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="话题ids" prop="subject">
        <el-input
          v-model="queryParams.subject"
          placeholder="请输入话题ids"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="invitationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="点赞数" align="center" prop="praiseNumber" />
      <el-table-column label="话题ids" align="center" prop="subject" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="点赞数" prop="praiseNumber">
          <el-input v-model="form.praiseNumber" placeholder="请输入点赞数" />
        </el-form-item>
        <el-form-item label="话题ids" prop="subject">
          <el-input v-model="form.subject" placeholder="请输入话题ids" />
        </el-form-item>
...
<script>
import { listInvitation, getInvitation, delInvitation, addInvitation, updateInvitation } from "@/api/app/invitation";
